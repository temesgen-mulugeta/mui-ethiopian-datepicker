import EthiopianDateCalendar from "./Components/EthiopianDateCalendar";
...
import { EtLocalizationProvider } from "./EtLocalizationProvider";

export default EtDatePicker;
export {
  EtDateViewer,
  EthiopianDate as EthiopianDateUtil,
